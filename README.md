...
- **Smart Authentication System** with 72-hour validity checking
...
### **How It Works**
1. **Authentication Validity Check**: Automatically checks if stored authentication is less than 72 hours old
...
### **Scenario 2: Valid Existing Authentication (< 72 hours)**
```
...
### **Scenario 3: Expired Authentication (> 72 hours)**
```
...
- **Validity Period**: 72 hours (configurable in `helpers/authHelpers.ts`)
...
- **Authentication expires frequently**: This is normal - the system uses 72-hour validity for security
